...
L_diagram_analysis_to_perform = [
        ['electric_field', 'Averaged', [1, 100], [-8.0, 8.0], 'on_fly', 10.1],
        ['electric_field', 'Averaged', [1, 21], [-7.1, 4], 'PE'],
...
where_to_run_QM = ['Plane_xy', 10, [8]]

moleculetype.read_optic_properties_input(GP, beta_calculation_style='QM', L_beta_ref=False, where_to_run_QM=where_to_run_QM, qmparameter=qmparameter, selection_tool=False)
...
L_diagram_analysis_to_perform = [
        ['electric_field', 'Averaged', [1, 10], [-10, 10], 'on_fly', 8],
        ['electric_field', 'Averaged', [1, 50], [-8.1, 7], 'PE'],
        ['beta', 'Averaged', [1, 200], [-35, 35]]
                              ]
