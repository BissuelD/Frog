...
GP.general_path = './Try_dir'
GP.dir_mol_times = 'DirMolTime'
GP.dir_torun_QM = 'DirQM' 
GP.dir_submission_file = 'DirSub'
...
where_to_run_QM = ['All']
selection_tool=traking_molecules = ['traking_molecules', [1]]


moleculetype.read_optic_properties_input(GP, beta_calculation_style='QM', L_beta_ref=False, where_to_run_QM=where_to_run_QM, qmparameter=qmparameter, selection_tool=selection_tool)
