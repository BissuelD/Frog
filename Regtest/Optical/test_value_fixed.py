...
moleculetype.read_optic_properties_input(GP,alpha_calculation_style='Fixed for all', L_alpha_ref=my_alpha_ref,  beta_calculation_style='Fixed for all', L_beta_ref=my_beta_ref)
