...
L_electric_field = [0.001, -0.02, 1] 
qmparameter.static_electric_field = L_electric_field
qmparameter.static_electric_field_direction = 'Molecular' #Laboratory or Molecular
...
moleculetype.read_optic_properties_input(GP, alpha_calculation_style='QM', beta_calculation_style='QM',  where_to_run_QM=where_to_run_QM, qmparameter=qmparameter)
