...
GP.nbr_mpi_dalton = 1 
GP.preference_functional = ['Camb3lyp']
...
qmparameter.calculation_style = 'PE + QM box' #'PE long'
qmparameter.pe_level = 0 # electrostatic environment 
qmparameter.max_pe_distance_neigh = 7
qmparameter.max_qm_box_distance_neigh = 4
...
qmparameter.preference_functional = ['Camb3lyp']
...
qmparameter.pe_level = 0 # electrostatic environment 
qmparameter.max_pe_distance_neigh = 6
