...
moleculetype.read_optic_properties_input(GP, alpha_calculation_style='QM', beta_calculation_style='Fixed for all', L_beta_ref=my_beta_ref,  where_to_run_QM=where_to_run_QM, qmparameter=qmparameter)
