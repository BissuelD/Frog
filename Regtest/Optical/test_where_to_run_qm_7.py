...
L_diagram_analysis_to_perform = [
    ['alpha', 'Layer', [2, 50], [-10, 10]],
    ['iota', 'Layer', [3, 50], [-10.0, 8.0]],
                              ]
...
where_to_run_QM = ['Layer', 1, [-1, 1]] 
selection_tool = ['traking_molecules', [918, 927, 9999999]] # only 2 molecules should be calculated
