...
GP.general_path = '/home/glebreton/Software/Frog/Usefull_file/Bash_script/R_' + str(R_cut)
...
where_to_run_QM = ['All']
traking_molecules = ['traking_molecules', [k for k in range(START, END, 1)]]
...
qmparameter.max_pe_distance_neigh = R_cut
