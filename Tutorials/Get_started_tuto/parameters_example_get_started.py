...
#########                            General Parameters                               #########
###############################################################################################
FROG_WD="./" # this directory
path = f'../Traj/Tuto_get_strated' # where is the MD trajectory
...
GP.general_path = f'{FROG_WD}'

GP.nbr_time_step = 10 # nbr of time step to treat, if N_time = 0 all the time will be treated, the default is 1 
GP.trotter_step = 4 # how many consecutive frame are not treated (1 means every frame are treated, 2, only one over 2, ect..). The default is 1
