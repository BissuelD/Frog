...
def compute_mean_position(L_pos):
    ...
    Here at the 'negative charge' position.
    '''
...
def electrostatic_description(pe_level, electro_description, L_pos=False):
    '''
    How to represent this molecule in an explicite electrostatic environement.
    The same electrostatic parameters are used as in the MD. The negative charge IS NOT at the oxygen position but at localisation X. 
    The positive charge are at the Hydrogen positions. 
    '''
